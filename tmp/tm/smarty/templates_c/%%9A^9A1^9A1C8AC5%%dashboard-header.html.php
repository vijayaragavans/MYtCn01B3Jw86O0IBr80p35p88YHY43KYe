<?php /* Smarty version 2.6.25, created on 2014-10-19 18:24:55
...
site/addnewsite"><i class="icon-tasks"></i>Add New Site</a></li>
                                <li><a href="<?php echo $this->_tpl_vars['base_url']; ?>
manageusers/index"><i class="icon-user"></i>Manage Users</a></li>
                                <li><a href="<?php echo $this->_tpl_vars['base_url']; ?>
site/managesites"><i class="icon-tasks"></i>Manage Sites</a></li>
                             <?php endif; ?>   
                                <li><a href="<?php echo $this->_tpl_vars['base_url']; ?>
overview/trackcode"><i class="icon-tasks"></i>Tracking Code</a></li>
                                <li><a href="<?php echo $this->_tpl_vars['base_url']; ?>
info/editprofile"><i class="icon-ok"></i> Edit Profile</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo $this->_tpl_vars['base_url']; ?>
